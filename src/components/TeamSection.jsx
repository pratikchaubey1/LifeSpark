...
const team = [
  { name: "Mr. Raju Yadav", role: "Post-Basic | From Bihar" },
  { name: "Mr. Sushil Yadav", role: "Post-Basic | From U.P." },
  { name: "Mr. Shiv Kumar", role: "Post-Basic | From Bihar, Rajgir" },
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4">
        {sectionTitle("Our Team", "Our WSE Company Dedicated Team Member")}
        <motion.div
          initial="hidden"
          whileInView="show"
